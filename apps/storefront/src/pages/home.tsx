          ...
          <div className="mt-auto space-y-3">
            <label className="flex items-center justify-between p-4 border border-[#3d2a1a]/20 rounded-lg cursor-pointer">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[#3d2a1a] text-xs uppercase tracking-wider font-bold">1 X CASE WITH 10 SAP</span>
              </div>
            ...
            <label className="flex flex-col p-4 border-2 border-[#3d2a1a] rounded-lg cursor-pointer">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[#3d2a1a] text-xs uppercase tracking-wider font-bold">1 X SUBSCRIPTION</span>
