...
// Accordion Component
const AccordionItem = ({ title, children, dotted = false, titleClassName, containerClassName, dotColor, thinIcon = false, smallThinIcon = false, isOpen: controlledOpen, onToggle, fixedHeight, hugContent = false }: { title: string; children: React.ReactNode; dotted?: boolean; titleClassName?: string; containerClassName?: string; dotColor?: string; thinIcon?: boolean; smallThinIcon?: boolean; isOpen?: boolean; onToggle?: () => void; fixedHeight?: number; hugContent?: boolean }) => {
    ...
    <div className={`border-t ${dotted ? `border-dotted ${dotColor || 'border-neutral-400'}` : 'border-black'}`}>
      ...
      >
        <div className="overflow-hidden">
          <div 
            className={`pb-5 flex flex-col justify-end transition-opacity duration-300 ${isOpen ? (hugContent ? '' : 'min-h-[400px]') + ' opacity-100' : 'opacity-0'}`}
          >
            {children}
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-stretch gap-8 md:gap-16">
        ...
        <div className="md:w-1/3 bg-white flex flex-col max-w-[360px]">
          ...
          <div className="space-y-3">
            <label 
              className={`flex items-center justify-between p-4 border rounded-lg cursor-pointer h-[56px] transition-colors ${purchaseType === "single" ? "border border-yellow-900 bg-white" : "border border-black"}`} 
            ...
            <label 
              className={`flex flex-col p-4 border rounded-[8px] cursor-pointer text-[14px] transition-colors ${purchaseType === "box" ? "border border-yellow-900 bg-white" : "border border-black"}`}
            ...
            >
              <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-2 ml-auto flex-shrink-0">
                    <span className="text-neutral-400 text-[14px] font-bold line-through">$75.00</span>
    ...
    <section className="py-16 px-8 bg-white">
      <div className="flex flex-col md:flex-row justify-center items-start gap-8 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col items-center text-center w-full md:w-1/3 max-w-[360px] h-[400px] relative">
            ...
            <div className="flex gap-2 justify-center relative z-10">
              <input
                ...
                className="w-[160px] px-3 h-[56px] bg-neutral-200 text-black text-sm font-bold uppercase tracking-wide placeholder:text-neutral-500 placeholder:font-bold rounded-[8px] outline-none"
              />
          ...
          <div className="flex flex-col items-center text-center w-full md:w-1/3 max-w-[360px] h-[400px] relative">
            ...
            <div className="flex-1 flex items-center w-full relative z-10">
              <p className="text-[20px] font-bold uppercase tracking-wide text-neutral-500 leading-snug w-full">
                Show Us Your Coffee Ritual at<br />@UncutCoffee
              </p>
            </div>
