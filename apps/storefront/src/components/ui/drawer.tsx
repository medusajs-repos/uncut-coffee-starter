  ...
  "fixed z-50 bg-white shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
        ...
        right:
          "inset-y-0 right-0 h-full w-full border-l border-neutral-200 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-[420px]",
      },
    },
    defaultVariants: {
      side: "right",
...
>(({ side = "right", className, children, hideClose, ...props }, ref) => (
  <DrawerPortal>
    ...
    >
      {!hideClose && (
        <DialogPrimitive.Close className="absolute right-6 top-5 text-neutral-500 hover:text-neutral-700 transition-colors focus:outline-none disabled:pointer-events-none">
